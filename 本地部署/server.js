...
const FIELDS = {
  ...
  tasks: ['名称','阶段','优先级','分类','真实开始日','真实完成日','截止日','完成','备注'],
...
const TYPES = {
  ...
  tasks: {名称:'text',阶段:'text',优先级:'text',分类:'text',真实开始日:'date',真实完成日:'date',截止日:'date',完成:'bool',备注:'text'},
...
function seedData(){
  const tasks = [
    { _id:genId(), '名称':'确认平面布局方案','阶段':'设计','优先级':'P0','分类':'设计','真实开始日':dd(-16),'真实完成日':dd(-7),'完成':true,'备注':'与设计师对齐收纳' },
    { _id:genId(), '名称':'墙体拆除','阶段':'拆改','优先级':'P1','分类':'拆改','真实开始日':dd(-6),'真实完成日':dd(-3),'完成':true,'备注':'' },
    { _id:genId(), '名称':'水电点位交底','阶段':'水电','优先级':'P0','分类':'水电','真实开始日':dd(-2),'截止日':dd(3),'完成':false,'备注':'现场定位' },
    { _id:genId(), '名称':'联系商家确认瓷砖到货时间','阶段':'','优先级':'P1','分类':'联系商家','截止日':dd(-7),'完成':false,'备注':'逾期示例' },
    { _id:genId(), '名称':'预约橱柜复尺','阶段':'','优先级':'P2','分类':'预约','截止日':dd(8),'完成':false,'备注':'' },
    { _id:genId(), '名称':'泥木进场施工','阶段':'泥木','优先级':'P1','分类':'泥木','真实开始日':dd(4),'完成':false,'备注':'' },
    { _id:genId(), '名称':'油漆完工验收','阶段':'油漆','优先级':'P2','分类':'油漆','完成':false,'备注':'' },
    { _id:genId(), '名称':'灯具安装','阶段':'安装','优先级':'P2','分类':'安装','完成':false,'备注':'' },
    { _id:genId(), '名称':'软装家具进场','阶段':'软装','优先级':'P2','分类':'软装','完成':false,'备注':'' }
  ];
  const budget = [
